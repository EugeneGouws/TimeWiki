# [SUPERSEDED — ARCHIVED 2026-07-26]

> This was the charter of the brainstorm-only phase. **Its "no building"
> rule no longer applies** — implementation is now in scope (see PRODUCT.md).
> Its data findings were folded into CLAUDE.md and
> docs/explorations/bounds-ladder.md. Kept for provenance only. Do not take
